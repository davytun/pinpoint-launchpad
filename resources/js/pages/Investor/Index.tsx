...
export default function Index() {
    ...
    const inputCls = (field: string) =>
        cn(
            'w-full rounded-xl border bg-white/80 px-4 py-3.5 text-sm text-zinc-900 placeholder-zinc-400 shadow-xs transition-all duration-300 focus:bg-white focus:ring-2 focus:ring-[#3A54A5]/10 focus:outline-none',
            errors[field as keyof typeof errors]
                ? 'border-red-300 focus:border-red-400 focus:ring-red-100'
                : 'border-zinc-200/80 focus:border-[#3A54A5]/40',
        );
    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Apply to join the Pinpoint Investment Network. Get visibility into validated early-stage dealflow evaluated under the PARAGON model."
                />
            </Head>
            ...
            <div className="relative min-h-screen bg-linear-to-b from-[#f1f4ff] via-[#f5f8ff] to-white font-sans text-zinc-900 selection:bg-zinc-950 selection:text-white">
                ...
                <section className="relative z-10 pt-20 pb-20 md:pt-28 md:pb-24">
                    <div className="mx-auto max-w-5xl px-6 md:px-8">
                        <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_1fr]">
                            ...
                            <div>
                                <FadeUp delay={0.06}>
                                    <span className="mb-3 block text-[11px] font-bold tracking-widest text-[#3A54A5] uppercase">
                                    ...
                                    <h1 className="font-display text-4.5xl leading-[1.05] font-bold tracking-tight text-zinc-950 sm:text-5xl md:text-6xl">
                                        The diligence is done. <br />
                                        What remains is your decision.
                                    </h1>
                                </FadeUp>
                                <FadeUp delay={0.1}>
                                    <p className="mt-6 max-w-2xl text-base leading-relaxed font-medium text-zinc-500">
                                        Every company you see in the PIN has been through the PARAGON assessment — its cap table reconciled, its IP
                                        chain checked, its numbers tested against its accounts, its founders interviewed apart.
                                    </p>
                                    <p className="mt-4 max-w-2xl text-sm leading-relaxed font-medium text-zinc-400">
                                        You are not sifting pitches. You are looking at companies whose weakest points have already been found and
                                        named.
                                    </p>
                                </FadeUp>
                                <FadeUp delay={0.14}>
                ...
                {/* ── Stat Band ── */}
                <section className="relative z-10 mx-auto mb-16 max-w-5xl px-6 md:px-8">
                    <div className="rounded-3xl border border-white/80 bg-white/30 p-8 shadow-[0_8px_30px_rgba(58,84,165,0.02)] backdrop-blur-md">
                        <div className="grid grid-cols-1 gap-8 text-center md:grid-cols-3 md:text-left">
                            {[
                                ...
                                <div key={idx} className="space-y-2 border-zinc-200/40 last:border-0 last:pr-0 md:border-r md:pr-8">
                                    <p className="font-display text-5xl font-black text-[#C8A951]">{item.stat}</p>
                                    <p className="text-[10px] leading-relaxed font-bold tracking-wider text-zinc-500 uppercase">{item.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section className="border-b border-zinc-200/50 bg-white py-24">
                    <div className="mx-auto max-w-5xl space-y-16 px-6 md:px-8">
                        <FadeUp className="max-w-3xl space-y-4">
                            ...
                            <p className="max-w-2xl text-base leading-relaxed text-zinc-500">
                                The problem was never finding companies. It was the weeks spent discovering, deep in diligence, the one thing that
                                ends the deal — the unassigned IP, the customer at sixty percent of revenue, the cap table that does not reconcile.
                            </p>
                        </FadeUp>

                        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                            {/* Sourcing without Pinpoint */}
                            <FadeUp delay={0.06} className="space-y-6 rounded-3xl border border-red-100 bg-[#FFF5F5]/30 p-8">
                                <div className="text-red-650 flex items-center gap-3">
                                ...
                                <ul className="text-zinc-650 space-y-4 text-sm">
                                    {[
                                        ...
                                        <li key={i} className="flex items-start gap-3">
                                            <span className="mt-0.5 font-sans text-red-500">•</span>
                                            <span>{li}</span>
                                        </li>
                                    ))}
                                </ul>
                            ...
                            <FadeUp delay={0.12} className="space-y-6 rounded-3xl border border-[#3A54A5]/15 bg-[#FAFBFF] p-8">
                                ...
                                <ul className="text-zinc-650 space-y-4 text-sm">
                                    {[
                                        ...
                                        <li key={i} className="flex items-start gap-3">
                                            <span className="mt-0.5 font-sans text-[#3A54A5]">•</span>
                                            <span>{li}</span>
                                        </li>
                                    ))}
                                </ul>
                        ...
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                            {[
                                ...
                                <FadeUp
                                    key={idx}
                                    delay={idx * 0.05}
                                    className="flex flex-col justify-between rounded-3xl border border-white/80 bg-white/30 p-6 shadow-[0_8px_30px_rgba(58,84,165,0.02)] backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:bg-white/50"
                                >
                                    <div className="space-y-4">
                                        <div className="flex items-baseline justify-between border-b border-zinc-200/60 pb-2">
                                            <span className="text-[9px] font-bold tracking-wider text-[#3A54A5] uppercase">{b.label}</span>
                                            <span className="font-mono text-xs font-bold text-[#C8A951]">{b.num}</span>
                                        </div>
                                        <h3 className="text-sm font-bold tracking-wide text-zinc-950 uppercase">{b.title}</h3>
                        ...
                        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.2fr_1fr]">
                            <FadeUp className="space-y-6">
                                ...
                                <p className="text-sm leading-relaxed font-medium text-zinc-500">
                                    Each company you see has been assessed across the full PARAGON framework — the same framework an investment
                                    committee reasons with, made explicit and consistent.
                                </p>

                                <div className="space-y-2 border-l-2 border-[#3A54A5] py-1 pl-6">
                                    <p className="text-zinc-650 text-xs leading-relaxed font-medium italic">
                                        What the PIN is not: a recommendation. Pinpoint assesses and makes visible; it does not advise you, endorse
                                        any company, or tell you where to invest. The judgement — and the decision — remain entirely yours.
                                    </p>
                                    <p className="text-[9px] font-bold tracking-wider text-zinc-400 uppercase">Verbatim legal disclaimer</p>
                                </div>
                            </FadeUp>
                            ...
                            <FadeUp delay={0.1}>
                                <div className="relative">
                                    ...
                                    <div className="flex flex-col items-center justify-center space-y-8 rounded-3xl border border-white/80 bg-white/40 p-8 shadow-[0_8px_30px_rgba(58,84,165,0.025)] backdrop-blur-md">
                                        <div className="grid w-full max-w-sm grid-cols-7 gap-2">
                                            {['P', 'A', 'R', 'A', 'G', 'O', 'N'].map((char, index) => (
                                                <div
                                                    key={index}
                                                    className="flex aspect-square flex-col items-center justify-center rounded-xl bg-linear-to-br from-[#3A54A5] to-[#2D4182] font-bold text-white shadow-[0_4px_12px_rgba(58,84,165,0.2)] transition-transform duration-300 hover:scale-105"
                                                >
                                                    <span className="text-lg font-bold sm:text-xl">{char}</span>
                                                </div>
                                            ))}
                                        </div>
                                        <div className="flex w-full flex-wrap justify-center gap-x-4 gap-y-2 text-center text-[9px] font-bold tracking-widest text-[#3A54A5] uppercase">
                                            <span>Potential</span> •<span>Agility</span> •<span>Risk</span> •<span>Alignment</span> •
                                            <span>Governance</span> •<span>Operations</span> •<span>Network</span>
                                        </div>
                                    </div>
                                </div>
                            </FadeUp>
                ...
                <section className="border-b border-zinc-200/50 bg-[#FAFBFF] py-24">
                    <div className="mx-auto max-w-5xl space-y-16 px-6 md:px-8">
                        <FadeUp className="max-w-3xl space-y-4">
                            ...
                            <h2 className="font-display sm:text-4.5xl text-3xl font-bold tracking-tight text-zinc-950">How membership works</h2>
                        </FadeUp>
                            ...
                            {[
                                {
                                    step: '1',
                                    title: 'You apply',
                                    desc: 'Complete the application below. It takes a few minutes and tells us your investment mandate.',
                                },
                                {
                                    step: '2',
                                    title: 'We verify & admit',
                                    desc: 'We confirm your status and eligibility. Admission is considered, not automatic.',
                                },
                                { step: '3', title: 'See profiles', desc: 'Once admitted, you gain visibility of companies matching your mandate.' },
                                {
                                    step: '4',
                                    title: 'Engage directly',
                                    desc: 'Where a company interests you, you deal with it directly, on your own terms.',
                                },
                            ].map((item, idx) => (
                                <FadeUp
                                    key={idx}
                                    delay={idx * 0.06}
                                    className="relative rounded-3xl border border-white/80 bg-white/30 p-6 shadow-[0_8px_30px_rgba(58,84,165,0.01)] backdrop-blur-md transition-all duration-300 hover:bg-white/50"
                                >
                                    <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-[#3A54A5]/10 text-sm font-black text-[#3A54A5]">
                                        {item.step}
                                    </div>
                                    <h3 className="mb-2 text-sm font-bold tracking-wide text-zinc-950 uppercase">{item.title}</h3>
                                    <p className="text-xs leading-relaxed font-medium text-zinc-500">{item.desc}</p>
                                </FadeUp>
                            ))}
                        </div>
                    </div>
                            ...
                            {[
                                {
                                    ...
                                    desc: "Individuals backing early-stage companies who want assessed dealflow without a fund's diligence team.",
                                },
                                {
                                    title: 'Venture funds',
                                    desc: 'Seed and growth funds seeking a verified top of funnel and a faster path through first-stage diligence.',
                                },
                                {
                                    title: 'Family offices',
                                    desc: 'Principals allocating to African venture who need the regulatory and governance picture surfaced early.',
                                },
                                {
                                    title: 'Syndicates & angel networks',
                                    desc: 'Lead investors assembling rounds who want a common benchmark to align their members around.',
                                },
                                {
                                    title: 'DFIs & impact investors',
                                    desc: 'Institutions whose mandates demand governance, compliance, and risk visibility as a condition of capital.',
                                },
                                {
                                    title: 'Corporate & strategic investors',
                                    desc: 'Corporates scanning for partners and targets, assessed against a consistent, disclosed standard.',
                                },
                            ].map((card, idx) => (
                                <FadeUp
                                    key={idx}
                                    delay={idx * 0.05}
                                    className="group relative overflow-hidden rounded-2xl border border-white/80 bg-white/30 p-6 shadow-[0_8px_30px_rgba(58,84,165,0.02)] backdrop-blur-md transition-all duration-300 hover:-translate-y-0.5 hover:border-[#3A54A5]/25 hover:bg-white/50 hover:shadow-[0_8px_30px_rgba(58,84,165,0.04)]"
                                >
                                    <h3 className="text-sm font-bold tracking-wide text-zinc-950 uppercase transition-colors group-hover:text-[#3A54A5]">
                                        {card.title}
                                    </h3>
                                    <p className="mt-2 text-xs leading-relaxed font-medium text-zinc-500">{card.desc}</p>
                                </FadeUp>
                            ))}
                        </div>
                    </div>
                ...
                <section className="relative overflow-hidden py-20">
                    <div className="mx-auto max-w-4xl px-6">
                        <FadeUp>
                            <div className="relative space-y-6 overflow-hidden rounded-4xl border border-white/80 bg-white/40 p-8 text-center shadow-[0_12px_40px_rgba(58,84,165,0.03)] backdrop-blur-md sm:p-14">
                                {/* Decorative gradient accent at top */}
                                <div className="absolute top-0 right-0 left-0 h-1 bg-linear-to-r from-[#3A54A5] via-[#6EBE44] to-[#C8A951]" />

                                <span className="text-[11px] font-bold tracking-widest text-[#3A54A5] uppercase">A word on admission</span>
                                <p className="font-display mx-auto max-w-2xl text-lg leading-relaxed font-extrabold text-zinc-900">
                                    The PIN is curated on both sides. Companies earn their place by being assessed; investors earn theirs by being who
                                    they say they are.
                                </p>
                                <p className="mx-auto mt-4 max-w-xl text-xs leading-relaxed font-medium text-zinc-500">
                                    We verify status, and we admit deliberately, because a network is only as valuable as its most careless member. If
                                    that is the kind of room you want to be in, apply below.
                                </p>
                            </div>
                        </FadeUp>
                    </div>
                ...
                <section id="apply" ref={applyRef} className="border-zinc-250/60 border-t bg-white py-24">
                    <div className="mx-auto max-w-3xl px-6 md:px-8">
                        <div className="mx-auto mb-14 max-w-2xl text-center">
                            ...
                            <p className="mt-3 text-sm font-medium text-zinc-500">
                                A few minutes. No cost to apply. We confirm your status before admitting you, and we treat everything you share in
                                confidence.
                            </p>
                        </div>
                        ...
                        <AnimatePresence mode="wait">
                            {submitted ? (
                                <motion.div
                                    ...
                                    exit={{ opacity: 0 }}
                                    className="space-y-6 rounded-3xl border border-zinc-200 bg-zinc-50 p-8 text-center shadow-xs sm:p-12"
                                >
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <p className="text-zinc-650 mx-auto max-w-md text-sm leading-relaxed">
                                            Thank you. We review every application individually and verify investor status before admission. You will
                                            hear from us at the email you provided.
                                        </p>
                                        <p className="mx-auto max-w-sm pt-4 text-[11px] font-medium text-zinc-400">
                                ...
                                <form
                                    ...
                                    className="space-y-12 rounded-4xl border border-white/80 bg-white/40 p-6 shadow-[0_8px_30px_rgba(58,84,165,0.02)] backdrop-blur-md sm:p-12"
                                >
                                    {/* Step 1: Who is applying */}
                                    <div className="space-y-6">
                                        <div className="flex items-center gap-3">
                                            <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[#3A54A5] font-mono text-xs font-bold text-white">
                                                1
                                            </span>
                                            ...
                                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
                                                {[
                                                    ...
                                                    <button
                                                        ...
                                                        className={cn(
                                                            ...
                                                            data.investor_type === type.value
                                                                ? 'border-[#3A54A5] bg-white shadow-xs ring-2 ring-[#3A54A5]'
                                                    ...
                                                    >
                                                        ...
                                                        <span className="mt-1 text-[10px] font-medium text-zinc-400">{type.sub}</span>
                                                    </button>
                                                ))}
                                            </div>
                                            {errors.investor_type && <p className="text-xs font-semibold text-red-500">{errors.investor_type}</p>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-8 border-t border-zinc-200 pt-8">
                                        <div className="space-y-1">
                                            ...
                                            <p className="pl-9 text-[10px] font-bold tracking-wider text-zinc-400 uppercase">
                                                            ...
                                                            <button
                                                                ...
                                                                className={cn(
                                                                    ...
                                                                    isSelected
                                                                        ...
                                                                        : 'hover:border-zinc-350 border-zinc-200 bg-white text-zinc-600',
                                                                )}
                                                            >
                                                                {s.label}
                                                            </button>
                                    ...
                                    <div className="space-y-6 border-t border-zinc-200 pt-8">
                                        ...
                                        <div className="space-y-4 pl-1 sm:pl-9">
                                            {[
                                                ...
                                                <label key={item.key} className="group flex cursor-pointer items-start gap-3 select-none">
                                                    <input
                                                        type="checkbox"
                                                    ...
                                                    <span className="text-zinc-550 group-hover:text-zinc-750 text-xs leading-relaxed">
                                                        {item.label}
                                                    </span>
                                                </label>
                                            ))}
                                            ...
                                            {(errors['confirmations.investor_status'] ||
                                                ...
                                                <p className="pt-2 text-xs font-semibold text-red-500">
                                    ...
                                    {/* Submit area */}
                                    <div className="space-y-4 border-t border-zinc-200 pt-8 text-center">
                                        <button
                                            type="submit"
                                            disabled={processing}
                ...
                <footer className="border-t border-zinc-200/50 bg-zinc-50 py-12">
                    <div className="mx-auto max-w-5xl px-6 text-center">
                        ...
                        <p className="mx-auto mt-3 max-w-2xl text-[11px] leading-relaxed font-medium text-zinc-400/80">
                            The PIN is a curated visibility channel, not a brokerage or investment adviser. Membership is subject to the Investor
                            Terms. Nothing on this page is an offer of securities or investment advice.
                        </p>
                    </div>
                </footer>
            </div>
