                ...
                <td className="px-4 py-3">
                    <div className="flex items-center gap-1.5">
                        <button
                            ...
                            title="Download"
                            className="rounded-lg border border-[#232C43] bg-[#0C1427] p-1.5 text-[#C1CDE8] transition-colors hover:bg-[#1B294B] hover:text-[#D8E0F3]"
                        >
                        ...
                        <button
                            ...
                            className={[
                                ...
                                doc.is_reviewed
                                    ? 'border-[#232C43] bg-[#0C1427] text-[#91A7D8] hover:bg-[#1B294B] hover:text-[#D8E0F3]'
                        ...
                        <button
                            ...
                            className={[
                                ...
                                noteOpen || doc.analyst_note
                                    ...
                                    : 'border-[#232C43] bg-[#0C1427] text-[#C1CDE8] hover:bg-[#1B294B] hover:text-[#D8E0F3]',
                            ].join(' ')}
                        >
                    ...
                    <td colSpan={5} className="px-4 py-3">
                        <div className="flex items-start gap-3">
                            ...
                            <button
                                ...
                                className="mt-5 rounded-xl border border-[#3A54A5]/30 bg-[#1B294B] px-4 py-2 text-[12px] font-semibold text-[#3A54A5] transition-colors hover:bg-[#3A54A5]/20 disabled:opacity-50"
                            >
                ...
                <div className="mx-auto max-w-5xl">
                    ...
                    {documents.length === 0 ? (
                        <div className="rounded-xl border border-[#232C43] bg-[#101623] py-16 text-center shadow-sm">
                            <FileText className="mx-auto mb-3 size-10 text-[#91A7D8]" aria-hidden="true" />
                            <p className="text-[14px] font-semibold text-[#C1CDE8]">No documents uploaded yet</p>
                            <p className="mt-1 text-[12px] text-[#91A7D8]">The founder has not uploaded any documents.</p>
                        </div>
                    ) : (
