        ...
        <div className="relative min-h-screen bg-[#050505] text-white antialiased">
            ...
            <div className="relative z-10 mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24">
                ...
                <motion.div {...fadeUp(0)} className="mb-14 flex justify-center">
                    <img src="/pinpoint-logo.png" alt="Pinpoint" className="block h-7 w-auto select-none" style={{ maxWidth: 150 }} />
                </motion.div>
                ...
                <motion.div {...fadeUp(0.08)} className="mb-10 text-center">
                    ...
                    <p className="mb-2 text-[10px] font-bold tracking-[0.26em] text-emerald-400/70 uppercase">Agreement Confirmed</p>
                    <h1 className="font-display text-3xl leading-tight font-semibold tracking-tight text-white sm:text-4xl">You're in.</h1>
                ...
                <motion.div {...fadeUp(0.18)} className="mb-8 grid gap-3 sm:grid-cols-2">
                    <div className="rounded-2xl border border-white/[0.07] bg-white/[0.03] p-5">
                        <p className="mb-1.5 text-[10px] font-bold tracking-[0.18em] text-white/30 uppercase">Audit Tier</p>
                    ...
                    <div className="rounded-2xl border border-white/[0.07] bg-white/[0.03] p-5">
                        <p className="mb-1.5 text-[10px] font-bold tracking-[0.18em] text-white/30 uppercase">Amount Paid</p>
                        <div className="flex items-center gap-2">
                            <FileText className="size-4 text-emerald-400" strokeWidth={1.5} />
                            <p className="text-[17px] font-semibold text-white">${Number(amount_paid).toLocaleString()} USD</p>
                        </div>
                    </div>

                    {email && (
                        <div className="rounded-2xl border border-white/[0.07] bg-white/[0.03] p-5">
                            <p className="mb-1.5 text-[10px] font-bold tracking-[0.18em] text-white/30 uppercase">Email</p>
                    ...
                    {signed_at && (
                        <div className="rounded-2xl border border-white/[0.07] bg-white/[0.03] p-5">
                            <p className="mb-1.5 text-[10px] font-bold tracking-[0.18em] text-white/30 uppercase">Signed</p>
                ...
                {/* ── What's next ── */}
                <motion.div {...fadeUp(0.26)} className="rounded-2xl border border-white/[0.07] bg-white/[0.03] p-6">
                    <p className="mb-5 text-[10px] font-bold tracking-[0.22em] text-white/30 uppercase">What happens next</p>
