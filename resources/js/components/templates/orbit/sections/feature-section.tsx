...
import { GlobeIcon, SquareMousePointerIcon, TrendingUpIcon } from 'lucide-react';
...
function FeatureCard({ children, className }: { children: React.ReactNode; className?: string }) {
    return (
        <div
            className={cn(
                'group bg-background/5 ring-foreground/5 relative overflow-hidden rounded-[2.5rem] border p-[0.375rem] shadow-sm ring-1 inset-shadow-2xs',
                className,
            )}
        >
            <div className="border-foreground/10 bg-background relative h-full w-full rounded-[calc(2.5rem-0.375rem)] border px-8 pt-8 pb-6 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
                {children}
            </div>
        </div>
    );
...
function FeatureTitle({ className, ...props }: React.ComponentProps<'h3'>) {
    return <h3 className={cn('text-foreground text-base leading-none font-medium tracking-tight', className)} {...props} />;
}

function FeatureDescription({ className, ...props }: React.ComponentProps<'p'>) {
    return <p className={cn('text-muted-foreground max-w-[40ch] text-sm leading-relaxed', className)} {...props} />;
}

function SetupVisual() {
    return (
        <>
            <div className="bg-background outline-border relative mx-auto flex size-16 items-center justify-center rounded-full border-4 border-dashed shadow-xs outline outline-offset-4">
                <div className="from-foreground/20 via-foreground/5 absolute inset-0 z-10 scale-120 bg-radial to-transparent blur-xl" />
                <CustomTimerIcon className="fill-primary/90 size-8" />
            </div>

            <div className="relative mt-8 space-y-1.5 text-center">
                <FeatureTitle>Instant Setup</FeatureTitle>
                <FeatureDescription>Get your entire team onboarded and ready to work in just a few clicks.</FeatureDescription>
            </div>
        </>
    );
}
...
function UserBasedSecurity() {
    return (
        <>
            <div className="bg-background outline-border relative mx-auto flex size-16 items-center justify-center rounded-full border shadow-xs outline outline-offset-4">
            ...
            <div className="relative mt-8 space-y-1.5 text-center">
                ...
                <FeatureDescription>Protect your data with role-based access control and enterprise-grade encryption.</FeatureDescription>
            </div>
        </>
    );
}
    ...
    return (
        <>
            <div className="min-h-32">
                ...
                <ReportsChartsSvg className="translate-x-[5%] scale-125 -rotate-2 md:scale-150" />
            </div>
            <div className="relative z-10 mt-8 space-y-1.5 text-center">
                <FeatureTitle>Advanced Analytics</FeatureTitle>
                <FeatureDescription>Gain actionable insights into your team&apos;s performance with customizable dashboards.</FeatureDescription>
            </div>
        </>
    );
}
    ...
    return (
        <div className="grid h-full sm:grid-cols-2">
            <div className="relative z-10 space-y-6 py-6 ps-8 pe-2">
                <div className="bg-card outline-border/80 flex size-8 items-center justify-center rounded-full border shadow-xs outline outline-offset-2">
                    <SquareMousePointerIcon className="text-primary/80 size-3" />
                </div>
                <div className="space-y-2">
                    <FeatureTitle className="text-xl md:text-xl">Intuitive Interface</FeatureTitle>
                    <FeatureDescription>Navigate your workflow effortlessly with our beautiful, meticulously crafted design.</FeatureDescription>
                </div>
            </div>
            {/* Dashboard Screen */}
            <div className="relative aspect-video mask-r-from-90% mask-b-from-90% sm:aspect-auto">
                <div className="border-foreground/10 bg-card absolute -right-1 -bottom-1 aspect-video max-h-50 rounded-tl-3xl border p-1 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] sm:max-h-42 md:aspect-square md:max-h-50 lg:aspect-16/12">
                    <div className="border-foreground/10 aspect-video h-full overflow-hidden rounded-tl-[calc(1.5rem-4px)] border object-cover *:pointer-events-none *:size-full *:shrink-0 *:select-none">
                        <img
    ...
    return (
        <div className="grid max-h-120 sm:grid-cols-2">
            <div className="space-y-6 pt-6 pb-4 pl-8 sm:pb-8">
                <div className="bg-card outline-border/80 flex size-8 items-center justify-center rounded-full border shadow-xs outline outline-offset-2">
                    <GlobeIcon className="text-primary/80 size-3" />
                </div>
                <div className="space-y-2">
                    <FeatureTitle className="text-xl md:text-xl">Global Availability</FeatureTitle>
                    <FeatureDescription>Access your workspace from anywhere in the world with our reliable edge network.</FeatureDescription>
                </div>
            </div>
...
function CustomLockIcon(props: React.ComponentProps<'svg'>) {
    return (
        <svg fill="none" viewBox="0 0 212 143" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path
            ...
            <path className="fill-primary stroke-primary" d="M3 72H209" strokeLinecap="round" strokeWidth="6" />
            <defs>
...
function ReportsChartsSvg(props: React.ComponentProps<'svg'>) {
    return (
        <svg fill="none" viewBox="0 0 300 128" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            />
            <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_106" x1="3" x2="3" y1="60" y2="123">
                    <stop className="text-primary/20" stopColor="currentColor" />
                    <stop className="text-background" offset="1" stopColor="currentColor" stopOpacity="0.103775" />
                </linearGradient>
