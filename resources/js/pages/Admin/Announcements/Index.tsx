                    ...
                    >
                        <label className="text-sm font-bold">
                            ...
                            <select
                                ...
                                className="mt-2 block w-full rounded-xl border border-zinc-200 bg-white p-3"
                            >
                        ...
                        <label className="text-sm font-bold">
                            ...
                            <select
                                ...
                                className="mt-2 block w-full rounded-xl border border-zinc-200 bg-white p-3"
                            >
                                <option value="active_investors">All active investors</option>
                                <option value="kyc_approved_investors">KYC-approved investors</option>
                        ...
                        <label className="text-sm font-bold">
                            ...
                            <input
                                ...
                                className="mt-2 block w-full rounded-xl border border-zinc-200 p-3"
                            />
                        </label>
                        <label className="text-sm font-bold">
                            Message
                            <textarea
                                ...
                                className="mt-2 block min-h-32 w-full rounded-xl border border-zinc-200 p-3"
                            />
                        </label>
                        <label className="text-sm font-bold">
                        ...
                        <button
                            ...
                            className="rounded-xl bg-[#3A54A5] px-5 py-3 text-sm font-bold text-white hover:bg-[#2D4182]"
                        >
