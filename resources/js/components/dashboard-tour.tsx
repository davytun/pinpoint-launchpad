...
export default function DashboardTour({ startTourKey = 0, onTourEnd }: DashboardTourProps) {
    ...
    useEffect(() => {
        ...
        driverInstance.current = driver({
            ...
            nextBtnText:
                'Next <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display: inline-block; vertical-align: middle; margin-left: 4px;"><path d="m9 18 6-6-6-6"/></svg>',
            prevBtnText:
                '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display: inline-block; vertical-align: middle; margin-right: 4px;"><path d="m15 18-6-6 6-6"/></svg> Back',
            doneBtnText: 'Finish',
            steps: [
                {
                ...
                },
                {
                    ...
                    popover: {
                        ...
                        description:
                            "This stepper displays the active status of your PARAGON certification. We've verified your Application, Payment, and Agreement. Next, our analysts will begin executing your assessment.",
                        side: 'bottom',
                        align: 'center',
                    },
                },
                {
                    ...
                    popover: {
                        ...
                        description:
                            'This shows your overall score (out of 100). It will unlock and display your final certified rating once our analysts complete their review.',
                        side: 'right',
                        align: 'center',
                    },
                },
                {
                    ...
                    popover: {
                        ...
                        description:
                            "This radar chart visualizes your company's score across all 7 pillars of PARAGON (Potential, Agility, Risk, Alignment, Governance, Operations, and Network).",
                        side: 'left',
                        align: 'center',
                    },
                },
                {
                    ...
                    popover: {
                        ...
                        description:
                            'Upload and manage requested corporate structure, financial statements, and pitch decks here. Quick action helps speed up audit execution.',
                        side: 'top',
                        align: 'center',
                    },
                },
                ...
                },
                {
                    ...
                    popover: {
                        ...
                        description:
                            'Your guided tour is complete. If you ever need to view this walkthrough again, you can restart it from the "Account Details" section below.',
                        side: 'bottom',
                        align: 'start',
                    },
                },
