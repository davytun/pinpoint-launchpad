            ...
            <div className="flex min-h-screen flex-col items-center justify-center px-4 py-16">
                ...
                <div className="w-full max-w-[400px]">
                    ...
                    <div className="relative overflow-hidden rounded-[2rem] border border-[#232C43] bg-[#101623] p-8 text-center shadow-2xl sm:p-10">
                        ...
                        {/* Copy */}
                        <p className="mb-2 text-[10px] font-bold tracking-[0.25em] text-[#91A7D8] uppercase">Transaction Stopped</p>
                        <h1 className="font-display mb-3 text-2xl leading-tight font-semibold text-[#D8E0F3] md:text-3xl">No Charge Made</h1>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <Link
                                ...
                                className="block w-full rounded-xl border border-[#232C43] bg-[#1B294B]/10 px-5 py-4 text-center text-[13px] font-bold tracking-[0.18em] text-[#91A7D8] uppercase transition-colors hover:bg-[#1B294B]/20 hover:text-[#D8E0F3]"
                            >
                                Back to My Results
                            </Link>
                        </div>
                    ...
                    {/* Reassurance note */}
                    <p className="mt-5 text-center text-xs text-[#91A7D8]/60">Your diagnostic score and results remain saved for 30 days.</p>
                </div>
            </div>
        </DiagnosticLayout>
    );
