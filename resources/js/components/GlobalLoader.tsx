...
export default function GlobalLoader() {
    ...
    return (
        <div className="fixed top-6 left-1/2 -translate-x-1/2 z-100 flex items-center gap-3 rounded-full border border-zinc-800 bg-zinc-950 px-5 py-2.5 text-[13px] font-semibold text-white shadow-2xl animate-in slide-in-from-top-4 fade-in-0 duration-200 zoom-in-95">
