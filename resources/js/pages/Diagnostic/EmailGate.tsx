                        ...
                        >
                            <div className="dx-card overflow-hidden rounded-xl p-0 md:rounded-2xl">
                                ...
                                <div className="flex flex-col items-center border-b border-zinc-100 px-8 pt-10 pb-8 text-center">
                                    ...
                                    {/* Headline */}
                                    <h1 className="font-display mb-2 text-2xl font-bold tracking-tight text-zinc-950">Your results are waiting.</h1>
                                    <p className="mb-6 text-sm leading-relaxed text-zinc-500">
                                        Enter your work details to unlock your full diagnostic and radar chart.
                                    </p>
                                ...
                                <div className="border-t border-zinc-100 bg-zinc-50/50 px-8 pt-7 pb-8">
                                    ...
                                    <form onSubmit={submit} noValidate className="flex flex-col gap-4">
                                        ...
                                        <div className="flex flex-col gap-1.5">
                                            <Label htmlFor="role" className="text-[9px] font-black tracking-[0.22em] text-zinc-500 uppercase">
                                                Role / Title
                                            </Label>
                                            <input
                                                id="role"
