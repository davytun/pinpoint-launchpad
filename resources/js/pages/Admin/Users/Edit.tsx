                ...
                <form onSubmit={submit} className="max-w-lg space-y-5">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            disabled={is_self}
                            className="w-full rounded-lg border border-[#232C43] bg-[#1B294B]/30 px-4 py-2.5 text-sm text-[#D8E0F3] transition-colors focus:border-[#3A54A5]/50 focus:outline-none focus:ring-1 focus:ring-[#3A54A5]/50 disabled:opacity-50"
                        >
