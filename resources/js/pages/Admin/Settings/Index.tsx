                    ...
                    <form onSubmit={submit} noValidate className="flex flex-col">
                        ...
                        {(flash?.success) && (
                            <div className="border-b border-zinc-100 bg-white px-6 py-3 text-right">
                                <span className="inline-flex items-center whitespace-nowrap rounded-full bg-emerald-50 px-3 py-1 text-[11px] font-semibold text-emerald-700">
                                    {flash.success}
                                </span>
                            </div>
                        )}
                                ...
                                <div>
                                    ...
                                    <div className="rounded-2xl border border-zinc-200/80 bg-white p-6 shadow-xs">
                                        <div className="mb-6 flex items-start justify-between gap-6">
                                            ...
                                            {/* Current value pill */}
                                            <span className="shrink-0 rounded-full border border-zinc-200 bg-zinc-50 px-3 py-1 text-xs font-bold text-zinc-600 shadow-xs tabular-nums">
                                                {cooldown_days}d
                                            </span>
                                        </div>
                                    ...
                                    <div className="rounded-2xl border border-zinc-200/80 bg-white p-6 shadow-xs">
                                        ...
                                        <div className="grid gap-5 md:grid-cols-2">
                                            <label className="flex flex-col gap-2">
                                                <span className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider">Button label</span>
                                                <input 
                                            ...
                                            <label className="flex flex-col gap-2">
                                                <span className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider">Destination URL</span>
                                                <input 
