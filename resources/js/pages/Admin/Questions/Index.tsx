...
function PillarBadge({ pillar }: { pillar: string }) {
    ...
    return (
        <span
            className="inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-bold tracking-[0.15em] uppercase"
            ...
            <div className="px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
                <div className="mx-auto max-w-5xl">
                    ...
                    <div className="mb-8 flex items-center justify-between">
                        <div>
                            <p className="mb-0.5 text-[11px] font-semibold tracking-[0.2em] text-[#C1CDE8] uppercase">Admin</p>
                    ...
                    <div className="overflow-hidden rounded-xl border border-[#232C43] bg-[#101623]">
                        <div className="overflow-x-auto">
                            <div className="min-w-[720px]">
                                {/* Table header */}
                                <div className="grid grid-cols-[40px_120px_1fr_60px_70px_72px] gap-4 border-b border-[#232C43] bg-[#0C1427]/50 px-5 py-3 text-[10px] font-bold tracking-[0.18em] text-[#91A7D8] uppercase">
                                    <span>#</span>
                                    <span>Pillar</span>
                                    <span>Question</span>
                                ...
                                {questions.data.map((q) => (
                                    ...
                                    >
                                        {/* Order */}
                                        <span className="font-mono text-sm font-semibold text-[#91A7D8]">{q.order}</span>

                                        {/* Pillar */}
                                        <PillarBadge pillar={q.pillar} />

                                        {/* Question text truncated */}
                                        <p className="truncate text-sm text-[#D8E0F3]" title={q.question_text}>
                                            {q.question_text}
                                        </p>

                                        {/* Points */}
                                        <span className="text-right text-sm font-semibold text-[#C1CDE8] tabular-nums">{q.points}</span>
                                        ...
                                        <div className="flex justify-end">
                                            <Link
                                                ...
                                                className="rounded-lg border border-[#232C43] bg-[#1B294B]/50 px-3 py-1.5 text-[11px] font-semibold tracking-[0.12em] text-[#C1CDE8] uppercase transition-all duration-150 hover:bg-[#1B294B] hover:text-[#D8E0F3]"
                                            >
                                                Edit
                                            </Link>
                                        </div>
                    ...
                    {questions.last_page > 1 && (
                        <div className="mt-5 flex items-center justify-between">
                            <p className="text-xs text-[#91A7D8]">{questions.total} questions</p>
