                        ...
                        <table className="w-full border-collapse text-left text-xs">
                            <thead className="sticky top-0 z-10 border-b border-zinc-200/80 bg-zinc-50/95 backdrop-blur-xs">
                                <tr>
                                    ...
                                    <th className="w-[15%] px-5 py-3 text-[11px] font-bold tracking-wider text-zinc-400 uppercase">Sector & Batch</th>
                                    ...
                                    <th className="w-[15%] px-5 py-3 text-[11px] font-bold tracking-wider text-zinc-400 uppercase">Verification</th>
                                        ...
                                        <td className="px-5 py-3.5">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="min-w-0">
                                                    <p className="truncate text-[13px] font-semibold text-zinc-950">{profile.company_name ?? '—'}</p>
                                        ...
                                        <td className="px-5 py-3.5">
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                <span className="text-[13px] font-semibold text-zinc-900 tabular-nums">
                                                    {profile.verified_badges_count} <span className="text-[11px] font-normal text-zinc-400">/ 7</span>
                                                </span>
                                            </div>
                                        </td>
