...
export default function AdminProfilesShow({ profile, founder, badges, access_requests, flash }: PageProps) {
    ...
    return (
        <AdminLayout>
            ...
            <div className="flex flex-col min-h-0 flex-1 overflow-y-auto no-scrollbar px-4 py-8 sm:px-8 lg:px-12 lg:py-10">
                <div className="mx-auto w-full max-w-6xl pb-20">
                    ...
                    <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            <Link
                                href="/admin/profiles"
                                className="inline-flex items-center gap-1.5 text-zinc-500 hover:text-zinc-900 mb-3 text-xs font-semibold transition-colors"
                            >
                            ...
                            <p className="text-zinc-500 mt-1.5 text-[13px] font-medium">
                    ...
                    <div className="grid gap-6 lg:grid-cols-12 items-start">
                        ...
                        <div className="lg:col-span-7 flex flex-col bg-white rounded-2xl lg:rounded-[22px] border border-zinc-200/80 shadow-[0_1px_3px_rgba(0,0,0,0.03)] overflow-hidden">
                            <div className="border-b border-zinc-100 px-6 py-4">
                                <h2 className="text-[13px] font-bold text-zinc-950">Profile Details</h2>
                                <p className="text-[11px] text-zinc-500 mt-0.5">Manage the data shown on the public verification profile.</p>
                            </div>
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div className="pt-2 border-t border-zinc-100">
                                    ...
                                    {Object.keys(radarData).length === 0 ? (
                                        <div className="flex flex-col items-start gap-3 rounded-xl border border-dashed border-zinc-200 bg-zinc-50/50 p-5 max-w-sm">
                                            <p className="text-[12px] text-zinc-500">No pillar scores have been computed or assigned for this profile.</p>
                                            <button
                                                type="button"
                                        ...
                                        <div className="space-y-4 max-w-sm">
                                            {PILLAR_KEYS.map((key) => (
                                                <div key={key} className="flex items-center gap-4">
                                                    <span className="w-24 text-[12px] font-semibold text-zinc-700 capitalize">
                                                        {key}
                                                    </span>
                                                    <input
                                                        type="range"
                                                        ...
                                                        style={{
                                                            background: radarData[key] !== undefined 
                                                                ? `linear-gradient(to right, #18181b ${radarData[key]}%, #f4f4f5 ${radarData[key]}%)` 
                                                                : '#f4f4f5'
                                                        }}
                                                        className="flex-1 h-1.5 rounded-full appearance-none cursor-pointer border border-zinc-200/60 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:border [&::-webkit-slider-thumb]:border-zinc-300 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:shadow-xs hover:[&::-webkit-slider-thumb]:border-zinc-400 [&::-webkit-slider-thumb]:transition-colors"
                                                    />
                                    ...
                                    <div className="flex items-center justify-between rounded-xl border border-zinc-200/90 bg-[#F9F9FB] p-4">
                                        <div>
                                            ...
                                            <p className="text-[11.5px] text-zinc-500 mt-0.5">
                                                {isPublic ? 'This profile is currently visible to approved investors.' : 'This profile is hidden and acting as a draft.'}
                                            </p>
                                        </div>
                                        <button
                                            type="button"
                                            ...
                                            className={cn(
                                                'relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus:outline-none shadow-2xs',
                        ...
                        <div className="lg:col-span-5 flex flex-col gap-6">
                            <div className="bg-white rounded-2xl lg:rounded-[22px] border border-zinc-200/80 shadow-[0_1px_3px_rgba(0,0,0,0.03)] overflow-hidden">
                                <div className="border-b border-zinc-100 px-6 py-4">
                                    <h2 className="text-[13px] font-bold text-zinc-950">Verification Badges</h2>
                                    <p className="text-[11px] text-zinc-500 mt-0.5">Toggle badges displayed on the profile.</p>
                                </div>
                                        ...
                                        >
                                            <div>
                                                ...
                                                {badge.is_verified && badge.verified_at && (
                                                    <p className="mt-0.5 text-[10.5px] text-zinc-400 font-medium">
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    'relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus:outline-none disabled:opacity-50 shadow-2xs',
                    ...
                    {access_requests.length > 0 && (
                        <div className="mt-6 bg-white rounded-2xl lg:rounded-[22px] border border-zinc-200/80 shadow-[0_1px_3px_rgba(0,0,0,0.03)] overflow-hidden flex flex-col">
                            <div className="border-b border-zinc-100 px-6 py-4">
                                <h2 className="text-[13px] font-bold text-zinc-950">Investor Access Requests</h2>
                                <p className="text-[11px] text-zinc-500 mt-0.5">Pending requests for this specific profile ({access_requests.length} total).</p>
                            </div>
                                ...
                                <table className="w-full min-w-150">
                                    <thead>
                                        <tr className="border-b border-zinc-100 bg-zinc-50/50">
                                            <th className="px-6 py-3 text-left text-[11px] font-bold tracking-wider text-zinc-500 uppercase">Investor</th>
                                            <th className="px-6 py-3 text-left text-[11px] font-bold tracking-wider text-zinc-500 uppercase">Firm</th>
                                            <th className="px-6 py-3 text-left text-[11px] font-bold tracking-wider text-zinc-500 uppercase">Email</th>
                                            <th className="px-6 py-3 text-left text-[11px] font-bold tracking-wider text-zinc-500 uppercase">Requested</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-zinc-100">
                                        {access_requests.map((req) => (
                                            <tr key={req.id} className="group transition-colors hover:bg-zinc-50/80">
                                                ...
                                                <td className="px-6 py-3.5 text-[12.5px] text-zinc-600 font-medium">{req.firm_name ?? '—'}</td>
                                                <td className="px-6 py-3.5 text-[12.5px] text-zinc-600">{req.investor_email}</td>
                                                <td className="px-6 py-3.5 text-[12.5px] text-zinc-500 font-medium tabular-nums">{new Date(req.created_at).toLocaleDateString()}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
