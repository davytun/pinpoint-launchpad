...
<p style="margin:0 0 28px;font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#4B5563;line-height:1.75;">
    A founder came to us with a score of 72 — almost identical to yours. Their <span style="color:#111827;font-weight:600;">{{ $session->primaryGap() }}</span> pillar was their biggest gap. They knew their product. They knew their market. But their unit economics were unverified and their cap table had dead equity from a departed co-founder.
</p>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
    style="background-color:#F0FDF4;border-radius:8px;border:1px solid #BBF7D0;border-left:3px solid #5ca336;margin-bottom:28px;">
    <tr>
...
<p style="margin:0 0 28px;font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#4B5563;line-height:1.75;">
    The audit did not change their business. It made their business <span style="color:#111827;font-weight:600;">provable</span>.
</p>
